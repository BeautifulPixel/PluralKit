...
namespace PluralKit.Bot
{
    public class CommandTree
    {
        ...
        public static Command SystemServerTag = new Command("system servertag", "system servertag [tag]", "Changes your system's server tag");
        ...
        public static Command[] SystemCommands = {
            SystemInfo, SystemNew, SystemRename, SystemTag, SystemServerTag, SystemDesc, SystemAvatar, SystemColor, SystemDelete, SystemTimezone,
        ...
        private async Task HandleSystemCommand(Context ctx)
        {
            ...
            else if (ctx.Match("servertag", "stag"))
        ...
        private async Task HandleSystemCommandTargeted(Context ctx)
        {
            ...
            if (target == null)
            {
                var list = CreatePotentialCommandList(SystemInfo, SystemNew, SystemRename, SystemTag, SystemServerTag, SystemDesc, SystemAvatar, SystemDelete, SystemTimezone, SystemList, SystemFronter, SystemFrontHistory, SystemFrontPercent);
                await ctx.Reply(
